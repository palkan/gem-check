...
You can automate your release process by using, for example, [`Gemsmith`](https://github.com/bkuhlmann/gemsmith) or CI services (e.g. [Travis supports](https://docs.travis-ci.com/user/deployment/rubygems/) RubyGems deployments).
